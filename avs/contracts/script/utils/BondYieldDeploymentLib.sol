...
library BondYieldDeploymentLib {
    using stdJson for *;
    using Strings for *;
    ...
    struct DeploymentData {
        address bondYieldServiceManager;
    ...
    function deployContracts(
...

        {
            ...
            result.bondYieldServiceManager = UpgradeableProxyLib.setUpEmptyProxy(proxyAdmin);
            result.stakeRegistry = UpgradeableProxyLib.setUpEmptyProxy(proxyAdmin);
        }
        deployAndUpgradeStakeRegistryImpl(result, core, quorum);
        deployAndUpgradeServiceManagerImpl(result, core, owner, rewardsInitiator, _oracleConsumer);
    ...
    function deployAndUpgradeStakeRegistryImpl(
        ...
        bytes memory upgradeCall = abi.encodeCall(
            ECDSAStakeRegistry.initialize, (deployment.bondYieldServiceManager, 0, quorum)
        );
    ...
    function deployAndUpgradeServiceManagerImpl(
        ...
        address bondYieldServiceManager = deployment.bondYieldServiceManager;
        address bondYieldServiceManagerImpl = address(
            new BondYieldServiceManager(
                core.avsDirectory,
        ...
        bytes memory upgradeCall = abi.encodeCall(
            BondYieldServiceManager.initialize, (owner, rewardsInitiator, _oracleConsumer)
        );

        UpgradeableProxyLib.upgradeAndCall(
            bondYieldServiceManager, bondYieldServiceManagerImpl, upgradeCall
        );
    }
    ...
    function readDeploymentJson(
        ...
        require(vm.exists(fileName), "BondYieldDeployment: Deployment file does not exist");

        string memory json = vm.readFile(fileName);

        DeploymentData memory data;
        /// TODO: 2 Step for reading deployment json.  Read to the core and the AVS data
        data.bondYieldServiceManager = json.readAddress(".addresses.bondYieldServiceManager");
    ...
    function writeDeploymentJson(
        ...
        writeDeploymentJson("deployments/bond-yield/", block.chainid, data);
    }
    ...
    function writeDeploymentJson(
        ...
        address proxyAdmin =
            address(UpgradeableProxyLib.getProxyAdmin(data.bondYieldServiceManager));
    ...
    function readDeploymentConfigValues(
        ...
        require(vm.exists(pathToFile), "BondYieldDeployment: Deployment Config file does not exist");
    ...
    function _generateContractsJson(
        ...
        return string.concat(
            ...
            '","bondYieldServiceManager":"',
            data.bondYieldServiceManager.toHexString(),
            '","bondYieldServiceManagerImpl":"',
            data.bondYieldServiceManager.getImplementation().toHexString(),
            '","stakeRegistry":"',
            ...
            '","oracleConsumer":"',
            data.oracleConsumer.toHexString(),
            '"}'
        );
    }
}
