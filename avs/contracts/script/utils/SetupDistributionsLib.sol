...
library SetupDistributionsLib {
    ...
    function createAVSRewardsSubmissions(
        ...
        ECDSAServiceManagerBase(bondYieldServiceManager).createAVSRewardsSubmission(
            rewardsSubmissions
        );
    }
    ...
    function createOperatorDirectedAVSRewardsSubmissions(
        ...
        ECDSAServiceManagerBase(bondYieldServiceManager).createOperatorDirectedAVSRewardsSubmission(
            rewardsSubmissions
        );
    }
