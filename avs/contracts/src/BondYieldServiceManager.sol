...
import {IBondYieldServiceManager} from "./IBondYieldServiceManager.sol";
...
/**
 * @notice Adapted from HelloWorld exaple
 */
contract BondYieldServiceManager is IBondYieldServiceManager, ECDSAServiceManagerBase {
    ...
    function respondToTask(
        ...
        IOracleConsumer(oracleConsumer).updateBondYtm(task.poolId, _ytm);
    }
