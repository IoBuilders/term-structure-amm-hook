...
import "../script/utils/BondYieldDeploymentLib.sol";
import "@eigenlayer/contracts/interfaces/IRewardsCoordinator.sol";
import "../src/IBondYieldServiceManager.sol";
...
import "../script/BondYieldDeployer.s.sol";
import {StrategyFactory} from "@eigenlayer/contracts/strategies/StrategyFactory.sol";
import {BondYieldTaskManagerSetup} from "test/BondYieldServiceManager.t.sol";
...
contract SetupDistributionsLibTest is Test, TestConstants, BondYieldTaskManagerSetup {
    using SetupDistributionsLib for *;

    Vm cheats = Vm(VM_ADDRESS);

    IRewardsCoordinator public rewardsCoordinator;
    IBondYieldServiceManager public bondYieldServiceManager;
    ...
    function setUp() public virtual override {
        ...
        ECDSAServiceManagerBase(bondYieldDeployment.bondYieldServiceManager).setRewardsInitiator(
            rewardsInitiator
        );
    ...
    function testCreateAVSRewardsSubmissions() public {
        ...
        mockToken.increaseAllowance(
            bondYieldDeployment.bondYieldServiceManager, amountPerPayment * numPayments
        );

        cheats.startPrank(rewardsInitiator);
        SetupDistributionsLib.createAVSRewardsSubmissions(
            address(bondYieldDeployment.bondYieldServiceManager),
            address(strategy),
            numPayments,
            amountPerPayment,
            duration,
